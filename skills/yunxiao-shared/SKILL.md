...
> **Network (#47):** GETs retry transient transport errors; create/write network failures print check before retry: with a list/search command — run it before re-POSTing.
